...
function Barchart() {
  const [CurentService, setCurentService] = useState("Service A");
  ...
  useEffect(() => {
    const selectedServiceObject = ServicesData.find((service) => service.name === CurentService);
  ...
  }, [selectedRangeConsumer, ServicesData, MostServiceConsumer]);
