...
const articleplusC = 
  ...
  return (
    <div style={{ display: "flex", gap: '20px', padding :'0px 180px' }}>
      <div className="Graph" style={{ flex: 1, marginRight: "10px"}}>
      <div style={{display: "flex",alignItems: "center", justifyContent: "space-between", marginTop:"20px"}}>
      <span  style={{ marginLeft:"20px", fontSize:'13px' }}>Produit Plus Consommé</span> 
    ...
    <option value="1 Week">1 Week</option>
      ...
      <div style={{display: "flex",alignItems: "center", justifyContent: "space-between", marginTop:"20px"}}>
      <span  style={{ marginLeft:"20px" , fontSize:'13px'}}>Produit Moins Consommé</span> 
     ...
     <span style={{ marginLeft:"20px", marginTop:"20px"  , fontSize:'13px'}}>Article Plus Consommé</span> 
     </div>
