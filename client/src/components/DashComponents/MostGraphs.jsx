...
const articleplusC = 
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      ...
      <span style={{ marginLeft:"20px", marginTop:"20px" }}>Service Plus Consommé</span> 
      </div>
        <span style={{  fontSize:"20px", marginTop :"0",marginLeft:"20px" }}>{ServiceplusC.nomproduit}</span>
        <b style={{fontSize:"26px",  marginTop :"0",marginLeft:"50px" }}>{ServiceplusC.quantite}</b>
        <Chart
          options={{
            xaxis: {
