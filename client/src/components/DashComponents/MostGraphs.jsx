...
const Graph = () => {
  ...
  const Serviceplusconsomee = {
    ...
    "1 Month": {
      ...
      series: [{ name: "Graph 1", data: [10, 50, 30, 90, 40] }],
    },
    "3 Months": {
      categories: ["2024-02-01", "2024-03-01", "2024-04-01"],
      series: [{ name: "Graph 1", data: [30, 40, 20] }],
    },
    "6 Months": {
      categories: [
        "2024-12-01",
      ...
      series: [{ name: "Graph 1", data: [30, 50, 70, 20, 90, 80] }],
    },
    "9 Months": {
      categories: [
        "2023-09-01",
  ...
  //data of produitplusconsome
  const produitplusC = { id: "0", nomproduit: "papier", quantite: "1290" };
  // data of produitplusconsome 1 week, 1 month, 3 months, 6 months, 9 months, and 1 year
  ...
  //data of produitplusconsome
  const produitmoinsC = { id: "0", nomproduit: "papier", quantite: "190" };
  // Data produitmoinsconsome
  const produitmoinsconsomee = {
    "1 Week": {
      categories: ["M", "T", "W", "T", "F", "S", "S"],
      series: [{ name: "Graph 2", data: [20, 30, 60, 80, 50, 90, 110] }],
    },
    "1 Month": {
      categories: [
        "2024-05-01",
      ...
      series: [{ name: "Graph 2", data: [30, 40, 70, 90, 60] }],
    },
    "3 Months": {
      categories: ["2024-02-01", "2024-03-01", "2024-04-01"],
      series: [{ name: "Graph 2", data: [40, 50, 80] }],
    },
    "6 Months": {
      categories: [
        "2023-12-01",
      ...
      series: [{ name: "Graph 2", data: [60, 90, 110, 80, 120, 140] }],
    },
    "9 Months": {
      categories: [
        "2023-09-01",
  ...
  const articleplusC = { id: "0", nomArticle: "article2", quantite: "120" };
  ...
  const Articleplusconsomee = {
    ...
    "6 Months": {
      ...
      series: [{ name: "Graph 2", data: [50, 60, 90, 110, 80, 120] }],
    },
    "9 Months": {
      categories: [
        "2023-09-01",
      ...
      series: [
        { name: "Graph 2", data: [100, 120, 60, 70, 100, 120, 90, 130, 150] },
      ],
    },
    "1 Year": {
      categories: [
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      <div className="Graph" style={{ flex: 1, marginRight: "10px" }}>
        ...
        >
          <span style={{ marginLeft: "20px", marginTop: "20px" }}>
            Service Plus Consommé
          </span>
        </div>
        <span style={{ fontSize: "20px", marginTop: "0", marginLeft: "20px" }}>
          {ServiceplusC.nomproduit}
        </span>
        <b style={{ fontSize: "26px", marginTop: "0", marginLeft: "50px" }}>
          {ServiceplusC.quantite}
        </b>
        <Chart
          options={{
            xaxis: {
      ...
      <div className="Graph" style={{ flex: 1, marginRight: "10px" }}>
        ...
        <span style={{ fontSize: "20px", marginTop: "0", marginLeft: "20px" }}>
          {produitplusC.nomproduit}
        </span>
        <b style={{ fontSize: "26px", marginTop: "0", marginLeft: "50px" }}>
          {produitplusC.quantite}
        </b>
        <Chart
          options={{
            xaxis: {
      ...
      <div className="Graph" style={{ flex: 1 }}>
        ...
        <span style={{ fontSize: "20px", marginTop: "0", marginLeft: "20px" }}>
          {produitmoinsC.nomproduit}
        </span>
        <b style={{ fontSize: "26px", marginTop: "0", marginLeft: "50px" }}>
          {produitmoinsC.quantite}
        </b>
        <Chart
          options={{
            xaxis: {
      ...
      <div className="Graph" style={{ flex: 1 }}>
        ...
        >
          <span style={{ marginLeft: "20px", marginTop: "20px" }}>
            Article Plus Consommé
          </span>
        </div>
        <span style={{ fontSize: "20px", marginLeft: "20px" }}>
          {articleplusC.nomArticle}
        </span>
        <b style={{ fontSize: "26px", marginTop: "0", marginLeft: "50px" }}>
          {articleplusC.quantite}
        </b>
