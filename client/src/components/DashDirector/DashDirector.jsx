    ...
    <div className='dwnusers'>
      ...
      <div   style={{ marginTop :"8vh" , marginLeft :' 7%' , width :'90%', height :'92vh' , padding :'10px'}}   >
            <div className='crcmd1' style={{display :'flex ' , alignItems: 'center', justifyContent:  'space-between'   }}>
                <div style={{display :'flex',height :'  auto '  , borderRadius : '20px' ,width:'100%',gap : '20px' ,   boxShadow: '0px 4px 14px rgba(0, 0, 0, 0.1)' ,padding : '2px' , marginBottom :'10px' }}>
         ...
         <div style={{ width: '78% ', height: '260px' ,   boxShadow: '0px 4px 14px rgba(0, 0, 0, 0.1)',borderRadius:'20px', padding :'20px' }}>
